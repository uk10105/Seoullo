...
let dummyTrips: [Trip] = [
    ...
    Trip(
        id: UUID(), startDate: Date.fromString("2024-08-15")!,
        endDate: Date.fromString("2024-08-20")!,
        dailyPlans: nil
    ),
    Trip(
        id: UUID(), startDate: Date.fromString("2024-12-24")!,
        endDate: Date.fromString("2024-12-31")!,
        dailyPlans: nil
    ),
    Trip(
        id: UUID(), startDate: Date.fromString("2024-05-01")!,
        endDate: Date.fromString("2024-05-05")!,
        dailyPlans: nil
    ),
    Trip(
        id: UUID(), startDate: Date.fromString("2024-10-01")!,
        endDate: Date.fromString("2024-10-07")!,
        dailyPlans: nil
    )
]
